...
### As built (capabilities B3 and B16, 22 September 2026)
...
**[A] The guard takes the keys back, not the deposit** (27 September 2026, [N54](open-questions.md)). Checking a guest out at the gate moves the unit to inspection exactly as the office's check-out does, and the deposit follows the process above — inspection, charges, approval — before anything is handed back. The guard never hands the BND 100 back: the office processes it in the few days after check-out ([N55](open-questions.md), Jeff).
...
**It takes `payment.record_cash` and mints no new permission.** Taking money at the counter is one job, and this section has twice taken that position already — verifying a deposit rides `payment.verify`, and the excess above one is settled by whoever may record a payment. **[A]** One qualification since 27 September 2026, when the guard came to hold `payment.record_cash` ([N54](open-questions.md)): a top-up — or a settled excess — recorded as a *transfer* is a claim about the bank rather than money counted, so it also takes `payment.verify` (§4).
...
### As built (capability B16, 17 September 2026) — a deposit that arrived short
...
- **It travels as an image with the reference beside it** (requirements 7–8): inline and attached in the confirmation email, as a download on the booking screen for the desk to forward over WhatsApp, and **[A]** on the guest's own booking page — because the email address is optional (§13), and a guest who gave none would otherwise have only the desk's WhatsApp (Jeff, 15 September 2026). 480 px at error correction M; printing is not built, so H is never needed.

**[C] The guard is the front desk** ([N54](open-questions.md), Jason, 14 September 2026): he hands the keys over, takes them back, admits day visitors and records the cash he is handed, and he cannot make a booking — where something needs one, the card says *Call the office*. So the screen answers one question per booking, what happens next and who does it, and says why in a sentence. The rules are **[A]**, Jeff's of 13 September 2026 and revised on 27 September for N54:
...
### As built (capabilities A6 and A7, 18 September 2026) — the guest sends it themselves

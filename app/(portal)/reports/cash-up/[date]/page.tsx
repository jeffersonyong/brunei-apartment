        ...
        <EmptyState
          ...
          action={
            <Button asChild variant="tertiary">
              <Link href="/reports/cash-up">Back to the cash-up</Link>
            </Button>
          }
        />
      </>
              ...
              {payments.map((payment) => (
                <TableRow key={payment.id} interactive className="group">
                  ...
                  <TableCell className="font-mono text-foreground tabular-nums">
                    <TableRowLink href={`/bookings/${payment.bookingReference}`}>
        ...
        {deposits.length > 0 ? (
          ...
          >
            <p className="text-body-sm text-copy">
              ...
              <Link href="/deposits" className="underline underline-offset-2">
                the deposits ledger
              </Link>{' '}
  ...
  return (
    <div className="flex items-center gap-xs">
      <Button asChild variant="tertiary" aria-label="Previous day">
        <Link href={`/reports/cash-up/${addDays(date, -1)}`}>

 ...
 *
 * `/units/3B-04` is a URL a staff member can read, say out loud and
 * recognise — the same reasoning `/bookings/PV-4821` follows. The cost
    ...
    <>
      ...
      <div className="mt-lg grid items-start gap-md lg:grid-cols-[minmax(0,1fr)_400px]">
                  ...
                  <Fact
                    ...
                    value={
                      <Button asChild variant="tertiary" className="font-mono">
                        <Link href={`/bookings/${unit.occupant.bookingReference}`}>
                          {unit.occupant.bookingReference}
                        </Link>
                      </Button>
                    }
            ...
            <SectionCard id="unit-last-stay" title="Last stay">
              <dl className="grid gap-md sm:grid-cols-2">
                ...
                <Fact
                  ...
                  value={
                    <Button asChild variant="tertiary" className="font-mono">
                      <Link href={`/bookings/${lastStay.reference}`}>{lastStay.reference}</Link>
                    </Button>
                  }
                />
                <Fact
        ...
        <SectionCard id="unit-history" title="History">
          <UnitHistory
            history={history}
            path={`/units/${encodeURIComponent(unit.ref)}`}

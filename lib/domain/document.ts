 ...
 */
export const ACCEPTED_MIME_TYPES: Readonly<Record<DocumentKind, readonly SniffedMimeType[]>> = {
...
export type UploadCheck =
  { ok: true; mimeType: SniffedMimeType; extension: string } | { ok: false; error: UploadError }

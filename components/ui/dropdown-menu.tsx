...
const menuItemClasses = [
  ...
  'data-[variant=destructive]:text-destructive data-[variant=destructive]:focus:text-destructive data-[variant=destructive]:[&_svg]:text-destructive',
]
...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(menuItemClasses, inset && 'pl-xl', className)}
      {...props}
    />
  )
}
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      checked={checked}
      className={cn(menuItemClasses, 'pl-xl', className)}
      {...props}
    >
      <span className="pointer-events-none absolute left-sm flex size-4 items-center justify-center">
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn(
        'px-md pt-sm pb-xs micro-label text-muted-foreground',
        inset && 'pl-xl',
        className,
      )}
      {...props}
...
/** Keyboard hints sit at caption scale in mute — never competing with the label. */
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(menuItemClasses, 'data-[state=open]:bg-muted', inset && 'pl-xl', className)}
      {...props}
    >
      {children}
